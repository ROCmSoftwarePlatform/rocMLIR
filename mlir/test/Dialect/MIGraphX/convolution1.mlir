...
module {
  func.func @main(%arg0: !migraphx.shaped<1x3x224x224xf32, 150528x50176x224x1>) -> !migraphx.shaped<1x64x112x112xf32, 802816x12544x112x1> {
    ...
    %5 = migraphx.convolution %arg0, %0 {acc_type = f32, padding = [3:i64, 3:i64], stride = [2:i64, 2:i64], dilation = [1:i64, 1:i64], group = 1:i64} : <1x3x224x224xf32, 150528x50176x224x1>, <64x3x7x7xf32, 147x49x7x1> -> <1x64x112x112xf32, 802816x12544x112x1>
