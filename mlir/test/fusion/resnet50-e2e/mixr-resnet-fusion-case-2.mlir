...
module {
  func.func @test(%arg0: !migraphx.shaped<1x256x14x14xf32, 0x1x0x0>, %arg1: !migraphx.shaped<1x256x28x28xf32, 200704x784x28x1>, %arg2: !migraphx.shaped<256x256x3x3xf32, 2304x9x3x1>) -> !migraphx.shaped<1x256x14x14xf32, 50176x196x14x1> {
    %1 = migraphx.convolution %arg1, %arg2 {acc_type = f32, dilation = [1, 1], group = 1 : i64, padding = [1, 1, 1, 1], padding_mode = 0 : i64, stride = [2, 2]} : <1x256x28x28xf32, 200704x784x28x1>, <256x256x3x3xf32, 2304x9x3x1> -> <1x256x14x14xf32, 50176x196x14x1>
