...
module {
  func.func @test(%arg0: !migraphx.shaped<1x128x28x28xf32, 0x1x0x0>, %arg1: !migraphx.shaped<1x512x28x28xf32, 401408x784x28x1>, %arg2: !migraphx.shaped<128x512x1x1xf32, 512x1x1x1>) -> !migraphx.shaped<1x128x28x28xf32, 100352x784x28x1> {
    %1 = migraphx.convolution %arg1, %arg2 {acc_type = f32, dilation = [1, 1], group = 1 : i64, padding = [0, 0, 0, 0], padding_mode = 0 : i64, stride = [1, 1]} : <1x512x28x28xf32, 401408x784x28x1>, <128x512x1x1xf32, 512x1x1x1> -> <1x128x28x28xf32, 100352x784x28x1>
