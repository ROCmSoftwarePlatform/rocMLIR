...
module {
  func.func private @mlir_attention(%v: !migraphx.shaped<2x2x32x32xf32, 2048x1024x32x1> {mhal.read_access}, 
                            %scale: !migraphx.shaped<2x4x1x32xf32, 128x32x32x1> {mhal.read_access}, 
                            %q: !migraphx.shaped<2x4x1x32xf32, 128x32x32x1> {mhal.read_access}, 
                            %k: !migraphx.shaped<2x2x32x32xf32, 2048x1024x32x1> {mhal.read_access},
                            %bias: !migraphx.shaped<2x4x1x32xf32, 128x32x32x1> {mhal.read_access}) 
                            -> (!migraphx.shaped<2x4x1x32xf32, 128x32x32x1> {mhal.write_access}) {
    ...
    %qk = migraphx.dot %q, %kt : <2x4x1x32xf32, 128x32x32x1>, <2x4x32x32xf32, 2048x1024x32x1> -> <2x4x1x32xf32, 128x32x32x1>
    %qk_scaled = migraphx.mul %qk, %scale : <2x4x1x32xf32, 128x32x32x1>, <2x4x1x32xf32, 128x32x32x1> -> <2x4x1x32xf32, 128x32x32x1>
    %qk_biased = migraphx.add %qk_scaled, %bias : <2x4x1x32xf32, 128x32x32x1>, <2x4x1x32xf32, 128x32x32x1> -> <2x4x1x32xf32, 128x32x32x1>
    %att = migraphx.softmax %qk_biased {axis = 3 : i64} : <2x4x1x32xf32, 128x32x32x1> -> <2x4x1x32xf32, 128x32x32x1>
    %res = migraphx.dot %att, %vreshaped : <2x4x1x32xf32, 128x32x32x1>, <2x4x32x32xf32, 2048x1024x32x1> -> <2x4x1x32xf32, 128x32x32x1>
    return %res : !migraphx.shaped<2x4x1x32xf32, 128x32x32x1>
  }
}
