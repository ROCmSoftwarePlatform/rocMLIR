...
module {
  func.func @test(%scale: !migraphx.shaped<3xf16, 1>, %arg1: !migraphx.shaped<1x128x56x56xf16, 401408x3136x56x1>, %arg2: !migraphx.shaped<128x128x3x3xi8, 1152x9x3x1>) -> !migraphx.shaped<1x128x28x28xf16, 100352x784x28x1> {
    ...
    %1 = migraphx.convolution %arg1, %2 {acc_type = f16, dilation = [1, 1], group = 1 : i64, padding = [1, 1, 1, 1], padding_mode = 0 : i64, stride = [2, 2]} : <1x128x56x56xf16, 401408x3136x56x1>, <128x128x3x3xf16, 1152x9x3x1> -> <1x128x28x28xf16, 100352x784x28x1>
