...
module {
  func.func @main0(%arg0: !migraphx.shaped<1x5x4x4xf32, 80x16x4x1>, %arg1: !migraphx.shaped<4x5x1x1xf32, 5x1x1x1>, %arg2: !migraphx.shaped<4xf32, 1>) -> !migraphx.shaped<1x4x4x4xf32, 64x16x4x1> attributes{kernel, arch = ""} {
    %0 = migraphx.convolution %arg0, %arg1 {acc_type = f32, padding = [0:i64, 0:i64, 0:i64, 0:i64], stride = [1:i64, 1:i64], dilation = [1:i64, 1:i64], group = 1:i64} : <1x5x4x4xf32, 80x16x4x1>, <4x5x1x1xf32, 5x1x1x1> -> <1x4x4x4xf32, 64x16x4x1>
